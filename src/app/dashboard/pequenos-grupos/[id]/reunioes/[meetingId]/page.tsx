...
import { ArrowLeft, Users, UserPlus, FileText, Settings, Calendar, MapPin, Clock, XCircle, CheckCircle } from 'lucide-react';
...
export default function MeetingDetailsPage() {
  ...
  const loadMeetingData = async () => {
    try {
      ...
      setMeeting(data.meeting); // Corrigido: acessar data.meeting
    } catch (error) {
               ...
               <CardContent className="space-y-6">
                 ...
                 <div className="pt-4 border-t border-gray-200">
                   <div className="flex gap-3">
                     <Button 
                       variant="outline" 
                       onClick={() => toast.success('Funcionalidade de edição será implementada')}
                     >
